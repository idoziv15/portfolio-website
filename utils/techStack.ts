export const techStack = {
  technologies: [
    ...
    { iconName: "/icons/redis.svg", name: "Redis" },
    { iconName: "/icons/kafka.svg", name: "Kafka" },
    { iconName: "/icons/rabbitmq.svg", name: "RabbitMQ" },
    { iconName: "/icons/kubernetes.svg", name: "Kubernetes" },
